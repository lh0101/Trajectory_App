...
#define TEMPO_TOTAL       10    // tempo total de toda a trajetória (mudei de 1.0f para 0.5f)
#define PTS_PER_SEG       5      // amostras por segmento

// ---- Cálculo dos tamanhos máximos ----
#define MAX_WP       ((MAX_PROGRAM_LINES - 1) * (N_INTERMEDIARIOS + 1))
// #define MAX_HIST_LEN ((MAX_WP - 1) * PTS_PER_SEG)
#define MAX_HIST_LEN 400

#include "trj_program.h"
int tst_getCurrentLine(void);
